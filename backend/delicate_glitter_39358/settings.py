"""
Django settings for delicate_glitter_39358 project.
...
ROOT_URLCONF = 'delicate_glitter_39358.urls'
...
WSGI_APPLICATION = 'delicate_glitter_39358.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delicate_glitter_39358 API",
    "DESCRIPTION": "API documentation for delicate_glitter_39358 App",
    "VERSION": "v1",
}
